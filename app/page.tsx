  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-gray-900 to-green-900">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        <div
          className="w-full inset-0 bg-cover bg-center"
          style={{
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
          ...
          <div className="space-y-4 max-w-md">
            {[
              ...
              <div key={i} className="flex items-center gap-4 p-4 bg-white/10 rounded-xl backdrop-blur-sm">
                <div className="w-12 h-12 rounded-full bg-green-600/20 flex items-center justify-center">
                  <i className={`bi ${item.icon} text-2xl text-green-400`}></i>
                </div>
                <div>
        ...
        <div className="bg-white/95 backdrop-blur-sm w-full max-w-xl p-8 lg:p-12 rounded-2xl shadow-2xl border border-white/20">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 px-4 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold rounded-lg hover:from-green-700 hover:to-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 shadow-lg transition"
            >
              {loading ? (
